...
const PFP_DATA_URI = "https://raw.githubusercontent.com/sourwisard/images/main/C1oud.png";
...
const CONFIG = {
  ...
  "hmmm cloud? hi there",
  "meow :3",
	"hmmm UwU hehe nice clip",
	"hold up sending somthing out of context",
	"yea you're probably ear raping yourself",
  "with that good ol ear cancer as you call it",
	"drugz?",
  "hmm i'm out of ideas",
	"probably change this later",
	"probably wasting my time coding or on roblox",
	"i'm going to clip you more :3",
	"is obsession really a bad thing?",
  "you're short",
	"https://www.youtube.com/watch?v=AFNmwFpyB3E",
	"https://www.youtube.com/watch?v=FFe4x-rSL7c",
	"panty and stocking with garterbelt???",
	"lmao",
	"cornhub",
	"fuck shit or something like that",
	"you're slow",
  ...
  viewerCount: 0,
  // ─── Colors ─────────────────────────────────────────────────────────
  accentColor:  "#7dd3fc",   // primary accent (name gradient, play btn, seek bar, playlist pill)
  accentColor2: "#afc2ff",   // secondary accent (card glow, name gradient end, album art bg)
...
// Tracks and playlists are no longer hardcoded here -- they're pulled at
// page-load time from the GitHub repo's metadata.json (the file
// github_uploader.py pushes to), same as workertest.js. Only playlists
// tagged "showOnWorker" in metadata.json's "playlists" settings are used;
// there's no "Play All" / all-tracks fallback here anymore.
...
<body>
  ...
  <a class="playlist-btn" href="https://music.youtube.com/playlist?list=PLaGBkrbP5ehdwUNzs3BEFkuDGB-YiJh8I&si=SfEDlB6zYuGBY4yX" target="_blank" rel="noopener">
...
<script>
  (function () {
    ...
    // Only playlists tagged "showOnWorker: true" in metadata.json's
    ...
    fetch(METADATA_URL, { cache: 'no-store' })
      ...
      .then((meta) => {
        ...
        const allowedNames = new Set(
          Object.keys(playlistSettings).filter((name) => playlistSettings[name] && playlistSettings[name].showOnWorker)
        );
