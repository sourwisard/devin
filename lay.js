...
const PFP_DATA_URI = "https://raw.githubusercontent.com/sourwisard/images/main/lay.png";
...
const CONFIG = {
  name: "lay",
  taglines: [
  "stop taking my fucking cats fr",
  "heh",
	"shiii what do i put in here",
	"https://pornhub.com/",
	"not even gonna look at this huh",
  "give me all your money",
	"drugz drugs drugs drugs drugs",
  "how can i drag this out more hmmmm",
	"xanax, meth, heroin, zaza, hmmmmmmm ",
	"how many more are there?",
	"oxycodone, codeine, hydrocodone",
	"damn really have no imagination",
  "i'm to lazy to change this one: you're short",
...
<script>
  (function () {
    ...
    // Only playlists tagged "showOnLay: true" in metadata.json's
    ...
    fetch(METADATA_URL, { cache: 'no-store' })
      ...
      .then((meta) => {
        ...
        const allowedNames = new Set(
          Object.keys(playlistSettings).filter((name) => playlistSettings[name] && playlistSettings[name].showOnLay)
        );
